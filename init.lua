...
--------------------------------------------------------------------
-- Designed to collect weather data from connected sensors and 
--  log to 'the cloud' (In this case thingspeak)
--
-- INTENDED USAGE
...
--------------------------------------------------------------------
function startup()
	dofile('main.lua') -- this is the file to call that you've previously saved on your NodeMCU
end

print("Begin Startup, remove or rename init.lua within 10s to abort")
print("Syntax: file.rename('init.lua', 'init.old')  ")
print("Then reboot.")
